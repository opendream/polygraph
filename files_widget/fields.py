...
try:
    ...
    add_introspection_rules([], ["^files_widget\.fields\.FileField"])
    add_introspection_rules([], ["^files_widget\.fields\.FilesField"])
    add_introspection_rules([], ["^files_widget\.fields\.ImageField"])
